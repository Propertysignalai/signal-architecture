...
const layerData = [
  ...
  { id: 'l2', label: 'L2', name: 'Intelligence Enrichment', hex: '#a855f7', desc: 'Strategy-blind enrichment & pattern recognition',
    ...
    blocked: ['No strategy access', 'No column defs', 'No signal classification. Raw findings pass through intact — L2 ADDS intelligence, never removes'] },
