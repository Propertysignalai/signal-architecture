...
const nodes = [
  ...
  },
  {
    ...
    status: 'built' as const,
    detail: 'A simple but critical step — all 10 agent outputs are merged into one package. No filtering, no prioritization. Everything passes through. The intelligence must be complete before enrichment.',
  },
  {
    id: 'l2', label: 'Layer 2: Intelligence Enrichment', icon: '🧠', color: 'green',
    summary: 'Strategy-blind enrichment. Pattern recognition, conflict detection, mosaic patterns.',
    ...
    status: 'built' as const,
    detail: 'Layer 2 knows NOTHING about the investor\'s strategy. It only sees raw intelligence from 10 domains. It ADDS enrichment on top — cross-domain tags, mosaic patterns, conflict detection, proxy validation, propensity to sell, and data quality scores. Raw findings pass through intact. Information is gained, never lost.',
  },
  {
